      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
            ...
            <p className="text-gray-400">Maintain your brand identity across every platform with automated guidelines</p>
          </div>
          
          <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
            <div className="text-3xl mb-4">📊</div>
            <h3 className="text-xl font-semibold mb-2">Analytics Dashboard</h3>
            <p className="text-gray-400">Track performance metrics and ROI across all your content channels</p>
          </div>
          
          <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
            <div className="text-3xl mb-4">⚡</div>
            <h3 className="text-xl font-semibold mb-2">Batch Processing</h3>
            <p className="text-gray-400">Process hundreds of videos simultaneously with enterprise infrastructure</p>
          </div>
        </div>
            ...
            <div className="bg-slate-800/30 rounded-2xl p-8 border border-slate-700">
              <div className="relative border-2 border-dashed rounded-xl p-12 border-slate-600 cursor-pointer transition-all duration-200 hover:border-blue-500">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-400">or drag & drop multiple files</p>
                  <p className="text-xs text-gray-500 mt-4">
                    Supports bulk uploads • Enterprise security
                  </p>
                </div>
              </div>
              
              <div className="mt-8 flex justify-center gap-4">
                <button className="px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg font-medium hover:opacity-90 transition">
                  Start Free Trial
                </button>
